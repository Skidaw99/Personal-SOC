/**
 * Cyber Operations Center — App Shell
 *
 * No sidebar. No tabs. No navigation.
 * Threat state drives everything.
 */
...
// ── Ticker bar (bottom, CALM + ELEVATED) ────────────────────────────────────
...
function CyberOpsCenter() {
  ...
  return (
    <div className={`ops-center ${stateClass} ${isCritical ? 'critical-active' : ''}`}>
      <ParticleGrid />
      <CriticalBanner />
